OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "Ο χρήστης «%s» επιχειρεί να συνδεθεί με μη έγκυρη διεύθυνση IP «%s».",
    "NOT_SHOWN_IN_LOG" : "NOT_SHOWN_IN_LOG",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "Ο χρήστης «%s» επιχειρεί να συνδεθεί με διεύθυνση IP «%s» από την αποκλεισμένη χώρα «%s».",
    "Login is delayed." : "Η σύνδεση έχει καθυστερήσει.",
    "Login is blocked." : "Η σύνδεση είναι αποκλεισμένη.",
    "No reaction is activated." : "Δεν είναι ενεργοποιημένη η αντίδραση.",
