OC.L10N.register(
    ...
    "No country is chosen but the selected ones" : "Δεν επιλέγεται καμιά χώρα εκτός από την επιλεγμένη",
    "All countries are chosen but the selected ones" : "Επιλέγονται όλες οι χώρες εκτός από τις επιλεγμένες",
