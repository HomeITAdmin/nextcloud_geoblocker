OC.L10N.register(
    ...
    "The database is currently updating, but the service can be used during the update." : "Η βάση δεδομένων ενημερώνεται αυτήν τη στιγμή, αλλά η υπηρεσία μπορεί να χρησιμοποιηθεί κατά τη διάρκεια της ενημέρωσης.",
    ...
    "Exception caught during Update:" : "Η εξαίρεση εντοπίστηκε κατά την ενημέρωση:",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "Η βάση δεδομένων περιέχει πληροφορίες για την παλιά έκδοση. Επαναφέρετε τη βάση δεδομένων χρησιμοποιώντας το εργαλείο γραμμής εντολών.",
    ...
    "Login attempts from local network IP addresses are not reacted on at all." : "Οι προσπάθειες σύνδεσης από τις διευθύνσεις IP του τοπικού δικτύου δεν αντιδρούν καθόλου.",
    ...
    "(Delaying is enforced for 30s before password check.)" : "(Η καθυστέρηση επιβάλλεται για 30 δευτερόλεπτα πριν από τον έλεγχο συνθηματικού.)",
    ...
    "(Blocking is enforced after password check!)" : "(Ο αποκλεισμός επιβάλλεται μετά τον έλεγχο συνθηματικού!)",
    "(Blocking is enforced before password check by throwing an \"login denied\" exception!)" : "(Ο αποκλεισμός επιβάλλεται πριν από τον έλεγχο κωδικού πρόσβασης, ρίχνοντας μια εξαίρεση \"δεν επιτρέπεται η είσοδος\"!)",
    "Test" : "Δοκιμή",
