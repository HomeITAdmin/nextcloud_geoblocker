OC.L10N.register(
    ...
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "Η προσπάθειά σας να συνδεθείτε από τη χώρα «%s» αποκλείστηκε από την εφαρμογή Nextcloud GeoBlocker. Εάν αυτό είναι πρόβλημα για εσάς, παρακαλούμε επικοινωνήστε με τον διαχειριστή σας.",
    ...
    "local" : "τοπικά",
    "default" : "προεπιλογή",
    "ERROR: There is an unknown problem with the service." : "ΣΦΑΛΜΑ: Υπάρχει ένα άγνωστο πρόβλημα με την υπηρεσία.",
    "ERROR: Country cannot be found." : "ΣΦΑΛΜΑ: Η χώρα δεν μπορεί να βρεθεί.",
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "ΣΦΑΛΜΑ: Η βάση δεδομένων δεν είναι έγκυρη, δεν έχει τα σωστά δικαιώματα πρόσβασης ή δεν τοποθετείται στο %s.",
    "ERROR: Invalid Argument." : "ΣΦΑΛΜΑ: Μη έγκυρο όρισμα.",
    "ERROR: \"geoip2.phar\" does not seem to be placed correctly or does not have the correct access rights." : "ΣΦΑΛΜΑ: Το «geoip2.phar» δεν φαίνεται να έχει τοποθετηθεί σωστά ή δεν έχει τα σωστά δικαιώματα πρόσβασης.",
    ...
    "ERROR:" : "ΣΦΑΛΜΑ:",
    "OK" : "Εντάξει",
    "IPv6 works only on 64-bit (or higher) systems. When upgrading the system to 64-bit remember to update the DB again." : "Το IPv6 λειτουργεί μόνο σε συστήματα 64-bit (ή υψηλότερα). Κατά την αναβάθμιση του συστήματος σε 64-bit θυμηθείτε να ενημερώσετε ξανά την βάση δεδομένων.",
    "The database is currently updating. During the update the service can be used with the last valid data." : "Η βάση δεδομένων ενημερώνεται αυτήν τη στιγμή. Κατά τη διάρκεια της ενημέρωσης, η υπηρεσία μπορεί να χρησιμοποιηθεί με τα τελευταία έγκυρα δεδομένα.",
    "The last update try ended in an error but the service can be used with the last valid data." : "Η τελευταία προσπάθεια ενημέρωσης κατέληξε σε σφάλμα, αλλά η υπηρεσία μπορεί να χρησιμοποιηθεί με τα τελευταία έγκυρα δεδομένα.",
    ...
    "No valid entries could be read for region \"%s\". Maybe the RIR has changed the file format." : "Δεν ήταν δυνατή η ανάγνωση έγκυρων καταχωρήσεων για την περιοχή «%s». Ίσως το RIR άλλαξε τη μορφή αρχείου.",
    "Not the right number of entries read for IPv4 in region \"%s\". Should have been %d but was %d." : "Δεν είναι ο σωστός αριθμός καταχωρήσεων που διαβάζονται για IPv4 στην περιοχή «%s». Θα έπρεπε να ήταν %d αλλά ήταν %d.",
    "Not the right number of entries read for IPv6 in region \"%s\". Should have been %d but was %d." : "Δεν είναι ο σωστός αριθμός καταχωρήσεων που διαβάζονται για IPv6 στην περιοχή «%s». Θα έπρεπε να ήταν %d αλλά ήταν %d.",
    "Exception caught during Update for region \"%s\": %s" : "Εξαίρεση καταγράφηκε κατά την ενημέρωση για την περιοχή «%s»: %s",
    "Invalid file handle for region \"%s\". Probably the internet connection got lost during the update." : "Μη έγκυρη λαβή αρχείου για την περιοχή «%s». Πιθανώς η σύνδεση στο Διαδίκτυο χάθηκε κατά την ενημέρωση.",
    ...
    "IPv6 is not included on systems with less than 64-bit." : "Το IPv6 δεν περιλαμβάνεται σε συστήματα με λιγότερα από 64-bit.",
    ...
    "Blocks user depending on the estimated country of their IP address." : "Αποκλείει τον χρήστη ανάλογα με την εκτιμώμενη χώρα της διεύθυνσης IP τους.",
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries.\nLogin attempts from local network IP addresses are never blocked, delayed or logged.\nIn the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country.\nWrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address.\nDetermination of the country from IP address is only as good as the chosen service.\n\nCountries can be specified using allowlisting or blocklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Regional Internet Registries (Nextcloud SQL database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the GitHub repository (homepage on the right side)." : "Αυτή είναι μια γραφική διεπαφή για τις υπηρεσίες γεωγραφικού εντοπισμού, που επιτρέπει τον αποκλεισμό (beta), την καθυστέρηση (beta) και την καταγραφή προσπαθειών σύνδεσης από συγκεκριμένες χώρες.\nΟι προσπάθειες σύνδεσης από τοπικές διευθύνσεις IP, ποτέ δεν αποκλείονται, καθυστερούν ή καταγράφονται.\nΣτην τρέχουσα εφαρμογή, η σελίδα σύνδεσης εμφανίζεται κανονικά σε όλους ανεξάρτητα από τη χώρα. Επίσης, οι προσπάθειες σύνδεσης με έναν μη υπάρχοντα χρήστη αποτυγχάνουν ως συνήθως ανεξάρτητα από τη χώρα.\nΗ λανθασμένη ρύθμιση του Nextcloud (ειδικά στο container) μπορεί να οδηγήσει σε όλη την πρόσβαση που φαίνεται να προέρχεται από τη διεύθυνση IP τοπικού δικτύου.\nΟ προσδιορισμός της χώρας από τη διεύθυνση IP είναι τόσο καλός όσο η επιλεγμένη υπηρεσία.\n\nΟι χώρες μπορούν να καθοριστούν χρησιμοποιώντας τη λίστα επιτρεπόμενων ή τη λίστα αποκλεισμών.\n\nΟι διαθέσιμες υπηρεσίες τοπικής προσαρμογής είναι:\n- Geoiplookup (τοπικό πρόγραμμα στον κεντρικό υπολογιστή)\n- MaxMind GeoLite2 (πρόσβαση σε τοπική βάση δεδομένων μέσω PHP API)\n- Δεδομένα από Περιφερειακά Μητρώα Διαδικτύου (βάση δεδομένων Nextcloud SQL δημιουργείται με δεδομένα που λαμβάνονται από τους διακομιστές RTP FTP)\n\nΓια βοήθεια σχετικά με τη ρύθμιση των υπηρεσιών εντοπισμού, ρίξτε μια ματιά στο αποθετήριο GitHub (αρχική σελίδα στη δεξιά πλευρά).",
    ...
    "Login attempts from local network IP addresses are never blocked, delayed or logged." : "Οι προσπάθειες σύνδεσης από τοπικές διευθύνσεις IP, ποτέ δεν αποκλείονται, καθυστερούν ή καταγράφονται.",
    "In the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country." : "Στην τρέχουσα εφαρμογή, η σελίδα σύνδεσης εμφανίζεται κανονικά σε όλους, ανεξάρτητα από τη χώρα. Επίσης, οι προσπάθειες σύνδεσης με έναν μη υπάρχοντα χρήστη αποτυγχάνουν ως συνήθως ανεξάρτητα από τη χώρα.",
    ...
    "If you are accessing from external network, this should be an external IP address:" : "Εάν έχετε πρόσβαση από εξωτερικό δίκτυο, αυτή θα πρέπει να είναι μια εξωτερική διεύθυνση IP:",
    ...
    "Location of the database (full path including the file name):" : "Τοποθεσία της βάσης δεδομένων (πλήρης διαδρομή συμπεριλαμβανομένου του ονόματος αρχείου):",
