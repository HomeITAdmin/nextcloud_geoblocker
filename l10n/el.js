OC.L10N.register(
    ...
    "ERROR: The database is not initialized. Please run update." : "ΣΦΑΛΜΑ: Η βάση δεδομένων δεν έχει αρχικοποιηθεί. Ελέγξτε   για ενημερώσεις.",
    "ERROR: The database is currently initializing. Please wait until update is finished. This may take several minutes." : "ΣΦΑΛΜΑ: Η βάση δεδομένων αρχικοποιείται. Περιμένετε μέχρι να ολοκληρωθεί η ενημέρωση. Αυτό μπορεί να πάρει μερικά λεπτά.",
    "ERROR: The database is corrupted. Please run update again." : "ΣΦΑΛΜΑ: Η βάση δεδομένων είναι κατεστραμμένη. Εκτελέστε ξανά την ενημέρωση.",
    "ERROR: The database is currently updating. Please wait until update is finished. This may take several minutes." : "ΣΦΑΛΜΑ: Η βάση δεδομένων ενημερώνεται. Περιμένετε μέχρι να ολοκληρωθεί. Αυτό μπορεί να πάρει μερικά λεπτά.",
    "ERROR: Something is missing." : "ΣΦΑΛΜΑ: Απουσία στοιχείου. ",
    ...
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. (Early Version)" : "Πρόκειται για υπηρεσίες γεωγραφικού εντοπισμού, επιτρέποντας τον αποκλεισμό (προς το παρόν μόνο καταγραφή!) των προσπαθειών σύνδεσης από συγκεκριμένες χώρες. (Πρώιμη Έκδοση)",
