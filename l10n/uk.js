OC.L10N.register(
    ...
    "No database date available." : "Дата бази даних відсутня.",
    ...
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "Ваша спроба входу з країни \"%s\" заблокована додатком Nextcloud GeoBlocker. Якщо у вас виникли проблеми, зверніться до вашого адміністратора.",
    "OK. This service always returns \"%s\" for \"Country not found\"." : "Гаразд. Ця служба завжди повертає \"%s\" для \"Країна не знайдена\".",
    "OK." : "Гаразд.",
    "ERROR: Service seem to be not installed on the host of the Nextcloud server or not reachable for the web server or is wrongly configured (is the database for IPv4 and IPv6 available?!). Maybe the use of the php function exec() is disabled in the php.ini." : "ПОМИЛКА: Служба, здається, не встановлена на хості сервера Nextcloud або недоступна для веб-сервера, або неправильно налаштована (чи доступна база даних для IPv4 та IPv6?!). Можливо, використання функції php exec() вимкнено у файлі  php.ini.",
    "Date of the database cannot be determined!" : "Дата створення бази даних не може бути визначена!",
    "local" : "локальна",
    "default" : "за замовчуванням",
    "ERROR: There is an unknown problem with the service." : "ПОМИЛКА: Існує невідома проблема зі службою.",
    "ERROR: Country cannot be found." : "ПОМИЛКА: Країна не знайдена",
    ...
    "Blocks user depending on the estimated country of thier IP address." : "Блокує користувача залежно від передбачуваної країни його IP-адреси.",
    ...
    "No country is blocked but the selected ones (blocklist)" : "Не блокується жодна країна, окрім обраних (blocklist) ",
    "All countries are blocked but the selected ones (allowlist)" : "Заблоковані всі країни, крім обраних (allowlist) ",
    ...
    "with IP Address" : "з IP-адресою ",
    "with Country Code" : "з кодом країни",
    "with username" : "з ім'ям користувача",
    ...
    "Activate delaying of login attempts from IP addresses of the specified countries." : "Активувати затримку спроб входу з IP-адрес зазначених країн. ",
    "(30 seconds)" : "(30 секунд) ",
    "Activate blocking of login attempts from IP addresses of the specified countries." : "Активувати блокування спроб входу з IP-адрес зазначених країн. ",
    "Test" : "Тест ",
