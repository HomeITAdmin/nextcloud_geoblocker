OC.L10N.register(
    ...
    "Location of the database (full path including the file name):" : "Місце знаходження бази даних (повний шлях, включаючи ім'я файлу):",
    ...
    "Select countries from list" : "Виберіть країну зі списку",
