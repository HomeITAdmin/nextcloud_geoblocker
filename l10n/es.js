OC.L10N.register(
    "geoblocker",
    {
    "Status of the service cannot be determinded." : "El estado del servicio no se ha podido determinar.",
    ...
    "ERROR: Service does not seem to be installed correctly or database is not available at %s." : "ERROR: el servicio parece no estar instalado correctamente o la base de datos no está disponible en %s. ",
    ...
    "with Country Code" : "con Código Postal",
    ...
    "Test" : "Prueba",
    "Possibilities to test if the Geoblocker is working as expected:" : "Posibilidades para probar si el Geoblocker está funcionando como se espera:",
