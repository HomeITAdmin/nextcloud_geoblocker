OC.L10N.register(
    ...
    "Invalid file handle for region \"%s\". Probably the internet connection got lost during the update." : "Identificador del archivo no válido para la región \"%s\". Probablemente se perdió la conexión a Internet durante la actualización.",
