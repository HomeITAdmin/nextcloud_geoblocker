OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "Una mala configuración de Nextcloud (especialmente en caso de contenedores) puede provocar que todo acceso parezca provenir de una dirección IP de la red local.",
    "If you are accessing from external network, this should be an external address: " : "Si estás accediendo desde una red externa, esta debería ser una dirección externa: ",
