OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "El usuario \"%s\" intentó iniciar sesión desde una dirección IP no válida \"%s\".",
    "NOT_SHOWN_IN_LOG" : "NOT_SHOWN_IN_LOG",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "El usuario \"%s\" intentó iniciar sesión desde una dirección IP \"%s\" de un país bloqueado \"%s\".",
    "Login is delayed." : "El inicio de sesión está retrasado.",
    "Login is blocked." : "El inicio de sesión está bloqueado.",
    "No reaction is activated." : "No hay una reacción activada.",
    ...
    "Activate blocking of login attempts from IP addresses of the specified countries." : "Activa el bloqueo de intentos de inicio de sesión de las direcciones IP desde los países indicados.",
