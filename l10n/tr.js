OC.L10N.register(
    ...
    "The database is currently updating, but the service can be used during the update." : "Veritabanı güncelleniyor. Ancak hizmet güncellenirken de kullanılabilir.",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "Veritabanında eski sürümden kalma bilgiler var. Komut satırı aracını kullanarak veritabanını sıfırlayın.",
    ...
    "Login attempts from local network IP addresses are not reacted on at all." : "Yerel ağ IP adreslerinden yapılan oturum açma girişimlerine tepki verilmez.",
    ...
    "(Delaying is enforced for 30s before password check.)" : "(Parola denetiminden önce 30 saniye gecikme uygulanır.)",
    ...
    "(Blocking is enforced after password check!)" : "(Engelleme parola denetiminden sonra yapılır!)",
    "(Blocking is enforced before password check by throwing an \"login denied\" exception!)" : "(Engelleme parola denetiminden önce yapılır ve \"oturum reddedildi\" koşulu işletilir!)",
    "Test" : "Sına",
