OC.L10N.register(
    ...
    "OK.  (Please make sure the databases are up to date. This is currently not checked here.)" : "Tamam (Lütfen veritabanının güncel olduğundan emin olun. Şu anda buradan denetlenemedi).",
    "ERROR: \"geoiplookup\" seem to be not installed on the host of the Nextcloud server or not reachable for the web server or is wrongly configured (is the database for IPv4 and IPv6 available?!). Maybe the use of the php function exec() is disabled in the php.ini." : "HATA:Ç \"geoiplookup\" Nextcloud kurulumununun bulunduğu sunucu üzerine kurulmamış gibi görünüyor ya da hatalı olarak yapılandırılmış (IPv4 ve IPv6 için veritabanı var mı?). PHP exec() işlevinin yürütülmesi php.ini içinde devre dışı bırakılmış olabilir.",
    ...
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. (Early Version)" : "Bu arayüz belirtilen ülkelerdeki kullanıcıların oturum açma girişimlerini engelleyen (şu anda yalnız günlük tutulur) bir coğrafi konum hizmetidir (Ön Sürüm)",
    ...
    "Choose the selection mode" : "Seçim modunu seçin",
    "No country is blocked but the selected ones" : "Seçilenler hariç hiçbir ülke blokeli değil",
    "All countries are blocked but the selected ones" : "Seçilenler hariç tüm ülkeler blokeli",
    "Select countries from list" : "Listeden ülkeleri seçiniz",
    "The following countries were selected in the list above: " : "Aşağıdaki ülkeler yukarıdaki listeden seçildi:",
    "Reaction" : "Tepki",
    "If a login attempt is detected from the chosen countries, the attempt is logged with the following information" : "Eğer seçili ülkelerden bir giriş tespit edilirse, aşağıdaki bilgiler ile birlikte durum kütük altına alınır",
    "( be aware of data protection issues depending on your logging strategy)" : "(kütük stratejisine göre oluşabilecek veri koruma sorunlarının farkında olun)",
    ...
    "Activate blocking of the login attempt from IP addresses of the specified countries." : "Belirlenmiş ülkeler için IP adresi bazlı giriş engellemeyi devreye al.",
    "Test" : "Test",
    "Next login attempt of user \"%s\" will be simulated to come from the following IP address:" : "\"%s\" kullanıcısı için olacak olan bir sonraki giriş denemesi aşağıdaki IP adresinden gelmiş gibi gösterilecektir:",
