OC.L10N.register(
    ...
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "HATA: Veritabanı geçersiz. Erişim izinleri doğru değil ya da %s içinde bulunamadı.",
    ...
    "The database is currently updating. During the update the service can be used with the last valid data." : "Veritabanı güncelleniyor. Güncelleme sırasında hizmet, geçerli son veritabanı ile kullanılabilir.",
    "The last update try ended in an error but the service can be used with the last valid data." : "Veritabanı güncelleniyor. Güncelleme sırasında hizmet, geçerli veritabanı ile kullanılabilir.",
