OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "\"%s\" kullanıcısı \"%s\" geçersiz IP adresinden oturum açmaya çalıştı.",
    "NOT_SHOWN_IN_LOG" : "GÜNLÜKTE_GÖRÜNTÜLENMEZ",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "\"%s\" kullanıcısı \"%s\" IP adresinden \"%s\" engellenmiş ülkesinden oturum açmaya çalıştı.",
    "Login is delayed." : "Oturum açma geciktirildi.",
    "Login is blocked." : "Oturum açma engellendi.",
    "No reaction is activated." : "Herhangi bir tepki etkinleşirilmemiş.",
