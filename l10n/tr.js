OC.L10N.register(
    ...
    "No database date available." : "Herhangi bir veri tabanı tarihi yok.",
    "Database file location not available!" : "Veri tabanı dosyasının konumu bulunamadı!",
    "Update Status not available!" : "Güncelleme durumu bilinmiyor!",
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "\"%s\" ülkesinden oturum açma girişiminiz Nextcloud GeoBlocker uygulaması tarafından engellendi. Bir hata olduğunu düşünüyorsanız BT yöneticiniz ile görüşün.",
    "OK. This service always returns \"%s\" for \"Country not found\"." : "Tamam. Bu hizmet \"Ülke bulunamadı\" için her zaman \"%s\" yanıtını verir.",
    "OK." : "Tamam.",
    "ERROR: Service seem to be not installed on the host of the Nextcloud server or not reachable for the web server or is wrongly configured (is the database for IPv4 and IPv6 available?!). Maybe the use of the php function exec() is disabled in the php.ini." : "HATA: Hizmet Nextcloud kurulumununun bulunduğu sunucu üzerine kurulmamış gibi görünüyor ya da hatalı olarak yapılandırılmış (IPv4 ve IPv6 için veri tabanı var mı?). PHP exec() işlevinin yürütülmesi php.ini içinde kullanımdan kaldırılmış olabilir.",
    "Date of the database cannot be determined!" : "Veri tabanının tarihi belirlenemedi!",
    "local" : "yerel",
    "default" : "varsayılan",
    "ERROR: There is an unknown problem with the service." : "HATA: Hizmet ile ilgili bilinmeyen bir sorun çıktı.",
    "ERROR: Country cannot be found." : "HATA: Ülke bulunamadı.",
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "HATA: Veri tabanı geçersiz. Erişim izinleri doğru değil ya da %s içinde bulunamadı.",
    "ERROR: Invalid Argument." : "HATA: Parametre geçersiz.",
    "ERROR: \"geoip2.phar\" does not seem to be placed correctly or does not have the correct access rights." : "HATA: \"geoip2.phar\" doğru konumda bulunamadı ya da için erişim izinleri doğru değil.",
    "No entries in the database. Please run update." : "Veri tabanında herhangi bir kayıt bulunamadı. Lütfen güncelleyin.",
    "ERROR:" : "HATA:",
    "OK" : "Tamam",
    "IPv6 works only on 64-bit (or higher) systems. When upgrading the system to 64-bit remember to update the DB again." : "IPv6 yalnızca 64 bit (veya üstü) sistemlerde çalışır. Sistemi 64 bit olarak yükseltirken veri tabanını yeniden güncellemeyi unutmayın.",
    "The database is currently updating. During the update the service can be used with the last valid data." : "Veri tabanı güncelleniyor. Güncelleme sırasında hizmet, geçerli son veri tabanı ile kullanılabilir.",
    "The last update try ended in an error but the service can be used with the last valid data." : "Veri tabanı güncelleniyor. Güncelleme sırasında hizmet, geçerli veri tabanı ile kullanılabilir.",
    "Last error message:" : "Son hata iletisi:",
    "PHP GMP Extension needs to be installed." : "PHP GMP eklentisinin kurulması gerekli.",
    "The database is not initialized. Please run update." : "Veri tabanı hazırlanamadı. Lütfen güncelleyin.",
    "The database is currently initializing. Please wait until update is finished. This may take several minutes." : "Veri tabanı hazırlanıyor. Lütfen güncelleme tamamlanana kadar bekleyin. Bu işlem birkaç dakika sürebilir.",
    "The database is corrupted. Please run update again." : "Veri tabanı bozulmuş. Lütfen yeniden güncelleyin.",
    "Something is missing." : "Bir şey eksik.",
    "No database available!" : "Kullanılabilecek bir veri tabanı bulunamadı!",
    "No valid entries could be read for region \"%s\". Maybe the RIR has changed the file format." : "\"%s\" bölgesi için geçerli bir kayıt okunamadı. RIR dosya biçimini değiştirmiş olabilir.",
    "Not the right number of entries read for IPv4 in region \"%s\". Should have been %d but was %d." : "\"%s\" IPv4 bölgesi için doğru kayıt sayısı okunamadı. %d olmalıydı ancak %d.",
    "Not the right number of entries read for IPv6 in region \"%s\". Should have been %d but was %d." : "\"%s\" IPv6 bölgesi için doğru kayıt sayısı okunamadı. %d olmalıydı ancak %d.",
    "Exception caught during Update for region \"%s\": %s" : "\"%s\" bölgesi güncellenirken sorun çıktı: %s",
    "Invalid file handle for region \"%s\". Probably the internet connection got lost during the update." : "\"%s\" bölgesinin dosya işleyicisi geçersiz. Büyük olasılıkla güncelleme sırasında İnternet bağlantısı kesildi.",
    ...
    "IPv6 is not included on systems with less than 64-bit." : "IPv6, 64 bit olmayan sistemlerde bulunmaz.",
    ...
    "Blocks user depending on the estimated country of their IP address." : "Kullanıcıları IP adresinden öngörülen ülkeye göre engeller.",
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries.\nLogin attempts from local network IP addresses are never blocked, delayed or logged.\nIn the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country.\nWrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address.\nDetermination of the country from IP address is only as good as the chosen service.\n\nCountries can be specified using allowlisting or blocklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Regional Internet Registries (Nextcloud SQL database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the GitHub repository (homepage on the right side)." : "Bu uygulama, belirli ülkelerden oturum açma girişimlerinin engellenmesini (beta), geciktirilmesini (beta) ve günlüğünün tutulmasını sağlayan, coğrafi yerelleştirme hizmetlerine yönelik bir ön yüzdür.\nYerel ağ IP adreslerinden yapılan oturum açma girişimleri hiçbir zaman engellenmez, geciktirilmez veya günlüğe kaydedilmez.\nVar olan uygulamada, oturum açma sayfası normalde ülkeden bağımsız olarak herkese görüntülenir. Ayrıca, var olmayan bir kullanıcının oturum açma girişimleri, ülkeden bağımsız olarak her zaman başarısız olur.\nYanlış Nextcloud yapılandırması (özellikle kapsayıcıda) tüm erişimin yerel ağ IP adresinden gelmesine neden olabilir.\nIP adresinden ülkenin belirlenmesi ancak seçilen hizmet kadar iyidir.\n\nÜlkeler, izin verilenler listesi veya engellenenler listesi kullanılarak belirtilebilir.\n\nŞu anda kullanılabilecek yerelleştirme hizmetleri:\n- Geoiplookup (sunucu üzerinde yerel uygulama)\n- MaxMind GeoLite2 (PHP API üzerinden erişilen yerel veri tabanı)\n- Regional Internet Registries verileri (RIR FTP sunucularından indirilen veriler ile oluşturulan Nextcloud SQL veri tabanı)\n\nYerelleştirme hizmetlerinin nasıl kurulacağı hakkında yardım almak için lütfen GitHub deposuna bakın (ana sayfayı sağ tarafta görebilirsiniz).",
    "Loading" : "Yükleniyor",
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries. " : "Coğrafi konum hizmetlerinin ön yüzü. Belirli ülkelerden gelen oturum açma girişimlerini günlüğe kaydeder, engeller (deneme aşamasında) ve geciktirir (deneme aşamasında).",
    "Login attempts from local network IP addresses are never blocked, delayed or logged." : "Yerel ağdan yapılan oturum açma girişimleri asla engellenmez, geciktirilmez ya da günlük kaydı tutulmaz.",
    "In the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country." : "Var olan uygulamada, oturum açma sayfası normalde ülkeden bağımsız olarak herkese görüntülenir. Ayrıca, var olmayan bir kullanıcının oturum açma girişimleri, ülkeden bağımsız olarak her zaman başarısız olur.",
    ...
    "Date of the database: " : "Veri tabanının tarihi:",
    "Configuration of the chosen service: " : "Seçilmiş hizmetin yapılandırması:",
    "Location of the database (full path including the file name):" : "Veri tabanının konumu (dosya adıyla birlikte tam yol):",
    ...
    "In addition, the login attempt can also be delayed and blocked." : "Ek olarak oturum açma girişimi geciktirilebilir ve engellenebilir.",
    "(beta version)" : "(deneme sürümü)",
    "Activate delaying of login attempts from IP addresses of the specified countries." : "Belirtilen ülkelerden gelen IP adreslerinden yapılan oturum açma girişimleri geciktirilsin.",
    "(30 seconds)" : "(30 saniye)",
    "Activate blocking of login attempts from IP addresses of the specified countries." : "Belirtilen ülkelerden gelen IP adreslerinden yapılan oturum açma girişimleri engellensin.",
    "Test" : "Sına",
