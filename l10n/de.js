OC.L10N.register(
    ...
    "ERROR: The database is not initialized. Please run update." : "FEHLER: Die Datenbank ist nicht initialisiert. Bitte das Update erneut ausführen.",
    "ERROR: The database is currently initializing. Please wait until update is finished. This may take several minutes." : "FEHLER: Die Datenbank wird gerade initialisiert. Bitte abwarten, bis das Update abgeschlossen ist. Dies kann einige Minuten dauern.",
    "ERROR: The database is corrupted. Please run update again." : "FEHLER: Die Datenbank ist beschädigt. Bittedas Update erneut ausführen.",
    "ERROR: The database is currently updating. Please wait until update is finished. This may take several minutes." : "FEHLER: Die Datenbank wird gerade initialisiert. Bitte abwarten, bis das Update abgeschlossen ist. Dies kann einige Minuten dauern.",
