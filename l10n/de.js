OC.L10N.register(
    ...
    "ERROR: The database is not initialized. Please run update." : "FEHLER: Die Datenbank ist nicht initialisiert. Bitte die Aktualisierung erneut ausführen.",
    "ERROR: The database is currently initializing. Please wait until update is finished. This may take several minutes." : "FEHLER: Die Datenbank wird gerade initialisiert. Bitte abwarten, bis die Aktualisierung abgeschlossen ist. Dies kann einige Minuten dauern.",
    "ERROR: The database is corrupted. Please run update again." : "FEHLER: Die Datenbank ist beschädigt. Bitte die Aktualisierung erneut ausführen.",
    "ERROR: The database is currently updating. Please wait until update is finished. This may take several minutes." : "FEHLER: Die Datenbank wird gerade initialisiert. Bitte abwarten, bis die Aktualisierung abgeschlossen ist. Dies kann einige Minuten dauern.",
    "ERROR: Something is missing." : "Fehler: Etwas fehlt.",
    "No database available!" : "Keine Datenbank vorhanden!",
    "Update not possible: \"allow_url_fopen\" needs to be allowed in php.ini." : "Aktualisierung nicht möglich: \"allow_url_fopen\" muss in php.ini zugelassen werden.",
    "Update not possible: PHP GMP Extension needs to be installed." : "Aktualisierung nicht möglich: PHP GMP-Erweiterung muss installiert werden.",
    ...
    "No country is blocked but the selected ones (blacklist)" : "Kein Land außer den ausgewählten Ländern ist blockiert (Blacklist)",
    "All countries are blocked but the selected ones (whitelist)" : "Alle Länder außer den ausgewählten Ländern sind blockiert (Whitelist)",
