OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "ERROR：無法存取 \"geoip2.phar\" ，這可能是因為沒有正確的權限或是它不在正確的位置。",
    "No entries in the database. Please run update." : "資料庫不存在任何實體。請執行更新程序。",
    "ERROR:" : "錯誤：",
    "OK" : "OK",
    "But IPv6 is only working on at least 64 bit systems. When upgrading the system from below 64bit remember to update the DB again." : "但 IPv6 僅適用於至少 64 位元的系統。從 64 位元以下的系統升級時，請記得再次更新資料庫。",
    ...
    "In the current implementation the login page is normally shown to everybody independend of the country. Also login attempts with a non existing user are failing as usual independend of the country." : "在目前的實作中，登入頁面會正常顯示給非該國家的所有人。非既有使用者的登入嘗試也會如非該國家那樣失敗。",
    ...
    "Location of the database: " : "資料庫位置：",
