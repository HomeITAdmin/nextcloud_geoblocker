OC.L10N.register(
    ...
    "Blocks user depending on the estimated country of their IP address." : "根據使用者的 IP 來推測其所在國家來封鎖他們。",
    ...
    "Location of the database (full path including the file name):" : "資料庫的位置（包含檔名的完整路徑）：",
