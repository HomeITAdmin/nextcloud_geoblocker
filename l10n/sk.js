OC.L10N.register(
    ...
    "ERROR: The database is not initialized. Please run update." : "CHYBA: Databáza nie je inicializovaná. Spustite aktualizáciu.",
    "ERROR: The database is currently initializing. Please wait until update is finished. This may take several minutes." : "CHYBA: Databáza sa práve inicializuje. Počkajte do skončenia aktualizácie. Môže to trvať niekoľko minúť.",
    "ERROR: The database is corrupted. Please run update again." : "CHYBA: Databáza je poškodená. Znova spustite aktualizáciu.",
    "ERROR: The database is currently updating. Please wait until update is finished. This may take several minutes." : "CHYBA: Databáza sa práve aktualizuje. Počkajte do skončenia aktualizácie. Môže to trvať niekoľko minúť.",
    "ERROR: Something is missing." : "CHYBA: Niečo chýba.",
    "No database available!" : "Databáza nie je k dispozícii!",
    "Update not possible: \"allow_url_fopen\" needs to be allowed in php.ini." : "Aktualizácia nie je možná: v php.ini musí byť povolené „allow_url_fopen“.",
    "Update not possible: PHP GMP Extension needs to be installed." : "Aktualizácia nie je možná: je potrebné nainštalovať rozšírenie PHP GMP.",
    ...
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. (Early Version)" : "Toto je nadstavba nad geolokačnými službami, ktorá umožňuje blokovanie (teraz iba zaznamenávanie!) pokusov o prihlásenie z určených krajín. (Skorá verzia)",
    "Loading" : "Načítava sa...",
