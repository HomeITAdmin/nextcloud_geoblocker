OC.L10N.register(
    ...
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "Váš pokus o prihlásenie z krajiny \"%s\": je zablokovaný aplikáciou Nextcloud GeoBlocker. Ak vám to robí problém, kontaktujte svojho správcu.",
    ...
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "CHYBA: Databáza nie je platná, nemá správne prístupové práva alebo nie je umiestnená na adrese %s.",
    "ERROR: Invalid Argument." : "CHYBA: Neplatný argument.",
    "ERROR: \"geoip2.phar\" does not seem to be placed correctly or does not have the correct access rights." : "CHYBA: Zdá sa, že „geoip2.phar“ nie je umiestnený správne alebo nemá správne prístupové práva.",
    ...
    "No valid entries could be read for region \"%s\". Maybe the RIR has changed the file format." : "Pre región „%s“ nebolo možné prečítať žiadne platné záznamy. Možno, že RIR zmenil formát súboru.",
    "Not the right number of entries read for IPv4 in region \"%s\". Should have been %d but was %d." : "V oblasti „%s“ nie je správny počet záznamov pre IPv4. Malo by to byť %d, ale je to %d.",
    "Not the right number of entries read for IPv6 in region \"%s\". Should have been %d but was %d." : "V oblasti „%s“ nie je správny počet záznamov pre IPv6. Malo by to byť %d, ale je to %d.",
    "Exception caught during Update for region \"%s\": %s" : "Počas aktualizácie regiónu \"%s\" bola zachytená výnimka: %s",
    ...
    "Blocks user depending on the estimated country of their IP address." : "Blokuje používateľov podľa krajiny odhadovanej podľa IP adresy.",
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries.\nLogin attempts from local network IP addresses are never blocked, delayed or logged.\nIn the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country.\nWrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address.\nDetermination of the country from IP address is only as good as the chosen service.\n\nCountries can be specified using allowlisting or blocklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Regional Internet Registries (Nextcloud SQL database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the GitHub repository (homepage on the right side)." : "Toto je klientske rozhranie pre služby geografickej lokalizácie, ktoré umožňuje blokovanie (beta), oneskorenie (beta) a zaznamenávanie pokusov o prihlásenie z daných krajín.\nPokusy o prihlásenie z adries IP lokálnej siete nie sú nikdy blokované, oneskorené ani zaznamenávané.\nV súčasnej implementácii sa prihlasovacia stránka bežne zobrazuje každému, nezávisle na krajine. Tiež pokusy o prihlásenie s neexistujúcim používateľom zlyhávajú ako obvykle, nezávisle od krajiny.\nNesprávna konfigurácia Nextcloudu (najmä v kontajneri) môže viesť k tomu, že všetky prístupy budú pochádzať z adresy IP miestnej siete.\nUrčenie krajiny z adresy IP je len také dobré ako zvolená služba.\n\nKrajiny je možné špecifikovať pomocou zoznamu povolených alebo blokovaných zoznamov.\n\nAktuálne dostupné lokalizačné služby sú:\n- Geoiplookup (miestny program na hostiteľovi)\n- MaxMind GeoLite2 (miestna databáza prístupná prostredníctvom PHP API)\n- Údaje z regionálnych internetových registrov (databáza Nextcloud SQL je zostavená s údajmi stiahnutými zo serverov FIR RIR)\n\nAk potrebujete pomoc s nastavením lokalizačných služieb, pozrite sa na úložisko GitHub (domovská stránka na pravej strane).",
    "Loading" : "Načítava sa...",
    ...
    "Location of the database (full path including the file name):" : "Umiestnenie databázy (úplná cesta vrátane názvu súboru):",
