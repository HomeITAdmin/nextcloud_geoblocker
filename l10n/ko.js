OC.L10N.register(
    ...
    "For help how to setup the localization services, have a look into the Readme in the" : "위치 서비스를 설정하는 방법에 대해 도움이 필요할 경우, 다음 Readme 파일을 참조하세요: ",
    "repository" : "repository",
    "Service" : "서비스",
    "Choose the service you want to use to determine the country from the IP Address:" : "IP 주소로 국가를 특정할 때 사용할 서비스를 고르세요:",
    ...
    "Choose the selection mode" : "선택 모드를 고르세요.",
    ...
    "( be aware of data protection issues depending on your logging strategy)" : "(로그 기록 방식에 따라서 데이터 보호 문제에 유의하세요.)",
