OC.L10N.register(
    ...
    "The database is currently updating, but the service can be used during the update." : "O banco de dados está sendo atualizado, mas o serviço pode ser usado durante a atualização.",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "O banco de dados contém informações sobre a versão antiga. Redefina o banco de dados usando a ferramenta de linha de comando.",
    ...
    "(Blocking is enforced before password check by throwing an \"login denied\" exception!)" : "(O bloqueio é aplicado antes da verificação de senha, lançando uma exceção \"login negado\"!) ",
    "Test" : "Teste",
