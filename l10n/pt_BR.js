OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "A configuração incorreta do Nextcloud (especialmente quando em contêiner) pode levar a que todo o acesso pareça vir do endereço IP da rede local.",
    "If you are accessing from external network, this should be an external address: " : "Se você está acessando a partir de uma rede externa, este deve ser um endereço externo:",
