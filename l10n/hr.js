OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "POGREŠKA: čini se da „geoip2.phar” nije pravilno postavljen ili nema točna prava pristupa.",
    ...
    "The database is currently updating, but the service can be used during the update." : "Baza podataka trenutačno se ažurira ali se servis može upotrebljavati tijekom ažuriranja.",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "Baza podataka sadrži zastarjele informacije o inačici. Resetirajte bazu podataka putem alata naredbenog retka.",
    ...
    "Login attempts from local network IP addresses are not reacted on at all." : "Ne reagira se na pokušaje prijave s IP adresa iz lokalne mreže.",
