OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "FOUT: \"geoip2.phar\" lijkt niet correct te zijn geplaatst of beschikt niet over de juiste toegangsrechten.",
    "No entries in the database. Please run update." : "Geen gegevens in de database. Voer alstublieft een update uit.",
    "ERROR:" : "FOUT:",
    "OK" : "OK",
    "But IPv6 is only working on at least 64 bit systems. When upgrading the system from below 64bit remember to update the DB again." : "Maar IPv6 werkt alleen op ten minste 64-bits systemen. Denk eraan om de DB opnieuw bij te werken als je het systeem vanaf 64 bits upgradet.",
    ...
    "In the current implementation the login page is normally shown to everybody independend of the country. Also login attempts with a non existing user are failing as usual independend of the country." : "In de huidige implementatie wordt de inlogpagina normaal gesproken aan iedereen getoond, onafhankelijk van het land. Ook inlogpogingen met een niet bestaande gebruiker mislukken zoals gebruikelijk, onafhankelijk van het land.",
