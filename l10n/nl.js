OC.L10N.register(
    ...
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "je inlogpoging vanuit het land \"%s\" wordt geblokkeerd door de Nextcloud GeoBlocker App. Neem contact op met je beheerder als dit een probleem is.",
    ...
    "local" : "lokaal",
    "default" : "standaard",
    "ERROR: There is an unknown problem with the service." : "FOUT: er trad een onbekende pronleem op met de service.",
    "ERROR: Country cannot be found." : "FOUT: Land kan niet worden gevonden.",
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "FOUT: Database is niet geldig, heeft niet de juiste toegangsrechten of staat niet op %s.",
    "ERROR: Invalid Argument." : "ERROR: Ongeldig argument.",
    "ERROR: \"geoip2.phar\" does not seem to be placed correctly or does not have the correct access rights." : "FOUT: \"geoip2.phar\" lijkt niet correct te zijn geplaatst of beschikt niet over de juiste toegangsrechten.",
    "No entries in the database. Please run update." : "Geen gegevens in de database. Voer alsjeblieft een update uit.",
    "ERROR:" : "FOUT:",
    "OK" : "OK",
    "IPv6 works only on 64-bit (or higher) systems. When upgrading the system to 64-bit remember to update the DB again." : "IPv6 werkt alleen op 64-bits (of hoger) systemen. Denk eraan om de DB opnieuw bij te werken als je het systeem naar 64 bits upgradet.",
    "The database is currently updating. During the update the service can be used with the last valid data." : "De database wordt momenteel bijgewerkt. Tijdens de update kan de service  worden gebruikt met de laatste geldige gegevens.",
    "The last update try ended in an error but the service can be used with the last valid data." : "De laatste update-poging eindigde in een fout, maar de service kan worden gebruikt met de laatste geldige gegevens.",
    ...
    "No valid entries could be read for region \"%s\". Maybe the RIR has changed the file format." : "Er kunnen geen geldige vermeldingen worden gelezen voor regio \"%s\". Misschien heeft de RIR het bestandsformaat gewijzigd.",
    "Not the right number of entries read for IPv4 in region \"%s\". Should have been %d but was %d." : "Niet het juiste aantal gelezen vermeldingen voor IPv4 in regio \"%s\". Had \"%d\" moeten zijn, maar was \"%d\".",
    "Not the right number of entries read for IPv6 in region \"%s\". Should have been %d but was %d." : "Niet het juiste aantal gelezen vermeldingen voor IPv6 in regio \"%s\". Had \"%d\" moeten zijn, maar was \"%d\".",
    "Exception caught during Update for region \"%s\": %s" : "Uitzondering opgetreden tijdens Update voor regio \"%s\":%s",
    "Invalid file handle for region \"%s\". Probably the internet connection got lost during the update." : "Ongeldige bestandsingang voor regio \"%s\". Waarschijnlijk is de internetverbinding verbroken tijdens de update.",
    ...
    "IPv6 is not included on systems with less than 64-bit." : "IPv6 is niet inbegrepen op systemen met minder dan 64-bits.",
    "Current number of entries:" : "Huidig ​​aantal waarden:",
    "Update in undefined state. Please complain to the developer." : "Updatestatus onbekend. Klaag bij de ontwikkelaar.",
    "GeoBlocker" : "GeoBlocker",
    "Blocks user depending on the estimated country of their IP address." : "Blokkeert gebruiker afhankelijk van het geschatte land van zijn IP-adres.",
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries.\nLogin attempts from local network IP addresses are never blocked, delayed or logged.\nIn the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country.\nWrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address.\nDetermination of the country from IP address is only as good as the chosen service.\n\nCountries can be specified using allowlisting or blocklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Regional Internet Registries (Nextcloud SQL database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the GitHub repository (homepage on the right side)." : "Dit is een front-end voor geolokalisatiediensten, die het blokkeren (bèta), uitstellen (bèta) en loggen van inlogpogingen uit bepaalde landen mogelijk maakt.\nInlogpogingen van lokale netwerk-IP-adressen worden nooit geblokkeerd, vertraagd of vastgelegd.\nIn de huidige implementatie wordt de inlogpagina normaal gesproken aan iedereen getoond, onafhankelijk van het land. Ook inlogpogingen met een niet bestaande gebruiker mislukken zoals gebruikelijk onafhankelijk van het land.\nVerkeerde Nextcloud-configuratie (vooral in container) kan ertoe leiden dat alle toegang lijkt te komen van het IP-adres van het lokale netwerk.\nBepaling van het land op basis van het IP-adres is slechts zo goed als de gekozen dienst.\n\nLanden kunnen worden gespecificeerd met behulp van toelatingslijsten of blokkeringslijsten.\n\nMomenteel beschikbare lokalisatiediensten zijn:\n- Geoiplookup (lokaal programma op de host)\n- MaxMind GeoLite2 (lokale database toegankelijk via PHP API)\n- Gegevens van regionale internetregisters (Nextcloud SQL-database opgebouwd met gegevens gedownload van de RIR's FTP-servers)\n\nVoor hulp bij het instellen van de lokalisatieservices kun je een kijkje nemen in de GitHub-repository (startpagina aan de rechterkant).",
    "Loading" : "Laden",
    ...
    "Login attempts from local network IP addresses are never blocked, delayed or logged." : "Pogingen om in te loggen vanaf IP-adressen uit het lokale netwerk worden nooit geblokkeerd, vertraagd of gelogd.",
    "In the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country." : "In de huidige implementatie wordt de inlogpagina normaal gesproken aan iedereen getoond, onafhankelijk van het land. Ook inlogpogingen met een niet bestaande gebruiker mislukken zoals gebruikelijk, onafhankelijk van het land.",
    ...
    "If you are accessing from external network, this should be an external IP address:" : "Als je toegang wilt vanaf een extern netwerk, zou dit een extern IP-adres moeten zijn:",
    "is local." : "is lokaal.",
    ...
    "Location of the database (full path including the file name):" : "Locatie van de database (volledig pad inclusief de bestandsnaam):",
