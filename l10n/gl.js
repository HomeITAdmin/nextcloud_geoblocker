OC.L10N.register(
    ...
    "The database is not initialized. Please run update." : "A base de datos non está preparada. Execute a actualización.",
    "The database is currently initializing. Please wait until update is finished. This may take several minutes." : "A base de datos está preparandose. Agarde ata que remate a actualización. Pode levar varios minutos.",
    ...
    "Login attempts from local network IP addresses are never blocked, delayed or logged." : "Os intentos de acceso desde os enderezos IP da rede local nunca se bloquean, se atrasan nin se rexistran.",
    ...
    "If you are accessing from external network, this should be an external IP address:" : "Se está accedendo desde a rede externa, este debería ser un enderezo IP externo:",
    "is local." : "é local.",
    ...
    "Reaction" : "Reacción",
    "If a login attempt is detected from the chosen countries, the attempt is logged with the following information" : "Se se detecta un intento de acceso desde os países escollidos, o intento rexístrase coa seguinte información",
    ...
    "Activate delaying of login attempts from IP addresses of the specified countries." : "Activar o atraso do intento de acceso desde os enderezos IP dos países especificados.",
    "(30 seconds)" : "(30 segundos)",
    "Activate blocking of login attempts from IP addresses of the specified countries." : "Activar o bloqueo dos intentos de acceso desde os enderezos IP dos países especificados.",
    "Test" : "Proba",
