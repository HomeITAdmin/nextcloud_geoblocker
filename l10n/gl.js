OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "O usuario «%s» tenta acceder cun enderezo IP non válido «%s».",
    "NOT_SHOWN_IN_LOG" : "NON_AMOSAR_NO_REXISTRO",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "O usuario «%s» tenta acceder cun enderezo IP non válido «%s» dende un país bloqueado «%s».",
    "Login is delayed." : "Foi atrasado o inicio de sesión.",
    "Login is blocked." : "O inicio de sesión está bloqueado.",
    "No reaction is activated." : "Non se activou ningunha reacción.",
    ...
    "The database is currently updating. Please wait until update is finished. This may take several minutes." : "A base de datos está actualizandose. Agarde ata que remate a actualización. Pode levar varios minutos.",
    "Something is missing." : "Falta algo.",
    "No database available!" : "Non hai base de datos dispoñíbel!",
    "RIR seems to have changed the file format." : "Parece que RIR cambiou o formato do ficheiro.",
    "Exception caught during Update." : "Excepción capturada durante a actualización.",
    "Invalid file handle. Probably the internet connection got lost during the update." : "Non hai un controlador de ficheiro válido. Probabelmente se perdeu a conexión a Internet durante a actualización.",
    ...
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries.\n\nCountries can be specified using allowlisting or blocklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Reginal Internet Registries (Nextcloud SQL database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the GitHub repository (homepage on the right side)." : "Isto é unha interface para os servizos de xeolocalización, que permite o bloqueo (beta), o atraso (beta) e o rexistro dos intentos de inicio de sesión de países especificados.\n\nOs países poden ser indicados na lista branca ou lista negra.\n\nOs servizos de localización dispoñíbeis na actualidade son:\n- Geoiplookup (programa do servidor local)\n- MaxMind GeoLite2 (base de datos local á que se accede a través do API de PHP)\n- Datos dos rexistros rexionais de Internet «RIR» (a base de datos SQL do Nextcloud constrúese con datos descargados dos servidores FTP dos RIR)\n\nPara obter axuda sobre como configurar os servizos de localización, bótelle unha ollada ao  repositorio Github (pódelo atopar na páxina principal na parte dereita).",
    "Loading" : "Cargando",
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries. " : "Esta é unha interface para os servizos de localización xeográfica, que permite o bloqueo (beta), o atraso (beta) e o rexistro dos intentos de inicio de sesión de países especificados.",
    "Login attempts from local network IP addresses are not reacted on at all." : "Os intentos de acceso dende os enderezos IP da rede local non reaccionan en absoluto.",
    ...
    "Activate blocking of login attempts from IP addresses of the specified countries." : "Activar o bloqueo dos intentos de inicio de sesión dende os enderezos IP dos países especificados.",
    "(Blocking is enforced after password check!)" : "(O bloqueo aplícase após a comprobación do contrasinal!)",
    "Test" : "Proba",
