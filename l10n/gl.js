OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "A configuración incorrecta  do Nextcloud (especialmente nun contedor) pode levar a que todo o acceso poida proceder do enderezo IP da rede local.",
    "If you are accessing from external network, this should be an external address: " : "Se está accedendo dende a rede externa, este debería ser un enderezo externo:",
