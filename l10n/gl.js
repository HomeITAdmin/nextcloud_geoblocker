OC.L10N.register(
    ...
    "ERROR: The database is not initialized. Please run update." : "ERRO: a base de datos non está iniciada. Execute a actualización.",
    "ERROR: The database is currently initializing. Please wait until update is finished. This may take several minutes." : "ERRO: a base de datos está iniciándose. Agarde ata que remate a actualización. Pode levar varios minutos.",
    "ERROR: The database is corrupted. Please run update again." : "ERRO: a base de datos está estragada. Volva executar a actualización.",
    "ERROR: The database is currently updating. Please wait until update is finished. This may take several minutes." : "ERRO: a base de datos está actualizandose. Agarde ata que remate a actualización. Pode levar varios minutos.",
    "ERROR: Something is missing." : "ERRO: falta algo.",
    "No database available!" : "Non hai base de datos dispoñíbel!",
    "Update not possible: \"allow_url_fopen\" needs to be allowed in php.ini." : "Non é posíbel actualizar: ten que estar permitido «allow_url_fopen» en php.ini.",
    "Update not possible: PHP GMP Extension needs to be installed." : "Non é posíbel actualizar: é necesario instalar a extensión PHP GMP.",
    "Update possible." : "A actualización é posíbel.",
