OC.L10N.register(
    ...
    "No country is chosen but the selected ones" : "Non se escolleu ningún país senón os seleccionados",
    "All countries are chosen but the selected ones" : "Escollese todos os países, pero os seleccionados",
    "The following countries were chosen: " : "Foron escollidos os seguintes países:",
    "Reaction" : "Reacción",
    "If a login attempt is detected from the blacklisted or not whitelisted countries, the attempt is logged with the following information (be aware of data protection issues)" : "Se se detecta un intento de inicio de sesión dende os países da lista negra ou non presentes na lista branca, o intento rexístrase coa seguinte información (teña en conta os problemas de protección de datos)",
    ...
    "Activate blocking of the login attempt from IPs of the specified countries." : "Activar o bloqueo do intento de inicio de sesión dende os enderezos IP dos países especificados.",
