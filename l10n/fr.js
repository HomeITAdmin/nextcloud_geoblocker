OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "Une mauvaise configuration de Nextcloud (spécifiquement dans un conteneur) peut faire croire que tous les accès viennent d'adresses IP locales.",
    "If you are accessing from external network, this should be an external address: " : "Si vous vous connectez depuis un réseau externe, cela devrait être une adresse externe:",
