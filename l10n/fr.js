OC.L10N.register(
    ...
    "OK.  (Please make sure the databases are up to date. This is currently not checked here.)" : "OK. (Veuillez vérifier que les bases de données sont à jour, ce qui n'est pas vérifié automatiquement ici).",
    "ERROR: \"geoiplookup\" seem to be not installed on the host of the Nextcloud server or not reachable for the web server or is wrongly configured (is the database for IPv4 and IPv6 available?!). Maybe the use of the php function exec() is disabled in the php.ini." : "Erreur: \"geoiplookup\" semble ne pas être installé sur l'hôte du serveur Nextcloud ou n'est pas atteignable par le serveur web ou est configuré de manière incorrecte (la base de données IPv4 et IPv6 est-elle disponible ?). Peut-être que la fonction exec() est désactivée dans php.ini.",
    ...
    "No country is chosen but the selected ones" : "Aucun pays n'est sélectionné en plus de ceux sélectionnés manuellement",
    "All countries are chosen but the selected ones" : "Tous les pays sont sélectionnés sauf ceux sélectionnés manuellement",
    "The following countries were chosen: " : "Les pays suivants ont été choisis:",
    "Reaction" : "Réaction",
    "If a login attempt is detected from the blacklisted or not whitelisted countries, the attempt is logged with the following information (be aware of data protection issues)" : "Si une tentative de connexion est détectée depuis un pays sur liste noire ou non sur liste blanche, la tentative est enregistrée avec les informations suivantes (attention aux problèmes de protection de  données)",
    ...
    "Activate blocking of the login attempt from IPs of the specified countries." : "Activer le blocage des tentatives de connexion depuis les adresses IP des pays spécifiés.",
