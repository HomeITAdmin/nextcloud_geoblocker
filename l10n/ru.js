OC.L10N.register(
    ...
    "ERROR: Service does not seem to be installed correctly or database is not available at %s." : "Ошибка: на %s не установлена служба или недоступна база данных.",
    ...
    "(Delaying is enforced for 30s before password check.)" : "(Установлена задежка в 30 с до проверки пароля).",
    "Test" : "Проверить",
