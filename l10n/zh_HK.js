OC.L10N.register(
    ...
    "local" : "本地",
    "default" : "預設",
    "ERROR: Service does not seem to be installed correctly or database is not available at %s." : "錯誤：服務似乎未安裝妥當或於 %s 上的資料庫尚未就緒。",
    ...
    "The database is currently initializing. Please wait until update is finished. This may take several minutes." : "資料庫正在初始化，這可能會花一點時間，請耐心等待。",
    "The database is corrupted. Please run update again." : "資料庫毀損，請重新執行更新程序。",
    "Last error message:" : "最新錯誤訊息。",
    "The database is currently updating, but the service can be used during the update." : "資料庫更新中，但服務在此期間仍然可用。",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "資料庫存放了舊的資料，請使用命令列指令重設資料庫。",
