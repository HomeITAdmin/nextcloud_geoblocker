OC.L10N.register(
    ...
    "The database is currently updating. During the update the service can be used with the last valid data." : "當前正在更新數據庫。在此期間，該服務將與最後一個有效數據一起使用。",
    ...
    "In the current implementation the login page is normally shown to everybody independent of the country. Also login attempts with a non existing user are failing as usual independent of the country." : "在當前的實現中，登錄頁面通常向所有人顯示，與國家無關。同樣，非現有用戶的失敗登錄嘗試也與國家無關。",
