OC.L10N.register(
    ...
    "Status of the service cannot be determined." : "無法識別目前服務狀態。",
    "No database date available." : "數據庫中無可用資料。",
    "Database file location not available!" : "數據庫檔案位置不可用。",
    "Update Status not available!" : "更新狀態不明。",
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "您從國家“%s”登錄的嘗試被 Nextcloud GeoBlocker 應用程式阻止。如果您遇到問題，請與管理員聯絡。",
    ...
    "ERROR: \"geoip2.phar\" does not seem to be placed correctly or does not have the correct access rights." : "錯誤：“geoip2.phar” 位置似乎不正確，或沒有正確的存取權限。",
    "No entries in the database. Please run update." : "數據庫不存在任何實體。請執行更新程序。",
    "ERROR:" : "錯誤：",
    "OK" : "OK",
    "IPv6 works only on 64-bit (or higher) systems. When upgrading the system to 64-bit remember to update the DB again." : "IPv6 僅適用於 64 位（或更高）系統。將系統升級到 64 位時，請記住再次更新數據庫。",
    "The database is currently updating. During the update the service can be used with the last valid data." : "目前正在更新數據庫。在此期間，該服務將與最後一個有效數據一起使用。",
    "The last update try ended in an error but the service can be used with the last valid data." : "上次更新中存在錯誤，但是該服務可以與最後一個有效數據一起使用。",
    ...
    "No valid entries could be read for region \"%s\". Maybe the RIR has changed the file format." : "無法讀取區域“%s”的有效條目。可能是RIR更改了檔案格式。",
    "Not the right number of entries read for IPv4 in region \"%s\". Should have been %d but was %d." : "在區域“%s”中為 IPv4 讀取的條目數不正確。應該為 %d，但值是 %d。",
    "Not the right number of entries read for IPv6 in region \"%s\". Should have been %d but was %d." : "在區域“%s”中為 IPv6 讀取的條目數不正確。應該為 %d，但值是 %d。",
    "Exception caught during Update for region \"%s\": %s" : "更新期間在區域“%s”中捕獲了異常：%s",
    "Invalid file handle for region \"%s\". Probably the internet connection got lost during the update." : "區域%s“”的檔案句柄無效。這可能是因為在更新時的網路連線中斷造成。",
    ...
    "If you are accessing from external network, this should be an external IP address:" : "如果您從外部網路存取，這應該是一個外部 IP 位置：",
    "is local." : "為區域網路。",
    "is external." : "為網際網路。",
    ...
    "Location of the database (full path including the file name):" : "數據庫的位置（包含檔名的完整路徑）：",
