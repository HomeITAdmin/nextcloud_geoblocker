OC.L10N.register(
    ...
    "ERROR:" : "錯誤：",
    "OK" : "OK",
    "But IPv6 is only working on at least 64 bit systems. When upgrading the system from below 64bit remember to update the DB again." : "IPv6 僅適用於 64 位（或更高）系統。 將系統升級到 64 位時，請記住再次更新數據庫。",
    ...
    "In the current implementation the login page is normally shown to everybody independend of the country. Also login attempts with a non existing user are failing as usual independend of the country." : "在當前的實現中，登錄頁面通常向所有人顯示，與國家無關。 同樣，非現有用戶的失敗登錄嘗試也與國家無關。",
