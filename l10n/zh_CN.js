OC.L10N.register(
    ...
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. (Early Version)" : "这是地理定位服务的一个前端，允许封锁（目前仅是记录！）来自指定国家的登录尝试。（早期版本）",
