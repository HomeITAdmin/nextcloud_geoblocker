OC.L10N.register(
    ...
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "Il tuo tentativo di accesso dalla nazione \"%s\" è bloccato dall'app Nextcloud GeoBlocker. Se per te è un problema, contatta l'amministratore.",
    ...
    "ERROR: Country cannot be found." : "ERRORE: nazione non trovata.",
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "ERRORE: il database non è valido, non ha i permessi di accesso giusti o non è presente in %s.",
    "ERROR: Invalid Argument." : "ERRORE: argomento non valido.",
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "ERRORE: \"geoip2.phar\" non sembra essere nel posto giusto o non ha i permessi di accesso giusti.",
