OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "ERRORE: \"geoip2.phar\" non sembra essere nel posto giusto o non ha i permessi di accesso corretti.",
    ...
    "The database is currently updating, but the service can be used during the update." : "Il database è in fase di aggiornamento. ma il servizio può essere utilizzato durante l'aggiornamento.",
    "Something is missing." : "Manca qualcosa.",
    "No database available!" : "Nessun database disponibile!",
    "RIR seems to have changed the file format." : "RIR sembra aver cambiato il formato del file.",
    "Exception caught during Update:" : "Eccezione intercettata durante l'aggiornamento:",
    "Invalid file handle. Probably the internet connection got lost during the update." : "Gestione del file non valida. Probabilmente la connessione Internet si è persa durante l'aggiornamento.",
    "Database contains old version information. Reset the database using the command line tool." : "Il database contiene informazioni sulla vecchia versione. Ripristina il database utilizzando lo strumento da riga di comando.",
    ...
    "This is a front end to geo localization services, that allows blocking (beta), delaying (beta) and logging of login attempts from specified countries.\n\nCountries can be specified using allowlisting or blocklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Regional Internet Registries (Nextcloud SQL database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the GitHub repository (homepage on the right side)." : "Questa è un'interfaccia per i servizi di geo-localizzazione, che consente il blocco (beta), il rinvio (beta) e la registrazione dei tentativi di accesso dalle nazioni specificate.\n\nLe nazioni possono essere specificate utilizzando una lista bianca o una lista di blocco.\n\nI servizi di localizzazione attualmente disponibili sono:\n- Geoiplookup (programma locale sull'host)\n- MaxMind GeoLite2 (accesso al database locale tramite API PHP)\n- Dati dai Registri Internet Regionali (database SQL Nextcloud creato con i dati scaricati dai server FTP dei RIR)\n\nPer assistenza su come configurare i servizi, dai un'occhiata al repository GitHub (pagina principale sul lato destro).",
    "Loading" : "Caricamento",
    ...
    "Login attempts from local network IP addresses are not reacted on at all." : "I tentativi di accesso da IP della rete locale non generano alcuna reazione.",
