OC.L10N.register(
    "geoblocker",
    {
    "The user \"%s\" logged in with IP address \"%s\" from blocked country \"%s\"." : "L'utente \"%s\" ha fatto l'accesso con indirizzo IP \"%s\" dalla nazione bloccata \"%s\".",
    ...
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. (Early Version)" : "Si tratta di un front end per servizi di geolocalizzazione, che permette il blocco (attualmente solo logging!) dei tentativi di accesso dalle nazioni specificate. (Versione precoce)",
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. " : "Si tratta di un front end per servizi di geolocalizzazione, che permette il blocco (attualmente solo logging!) dei tentativi di accesso dalle nazioni specificate.",
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "Configurazioni errate di Nextcloud (specialmente in contenitori) possono far sembrare tutti gli accessi provenire da IP della rete locale.",
    "If you are accessing from external network, this should be an external address: " : "Se stai accedendo da una rete esterna, questo dovrebbe essere un indirizzo esterno:",
    ...
    "Blacklisting" : "In lista nera",
    "Whitelisting" : "In lista bianca",
    "the following entries" : "i seguenti elementi",
    "The following countries were chosen: " : "Sono state scelte le seguenti nazioni:",
    "Reaction" : "Reazione",
    "If a login attempt is detected from the blacklisted or not whitelisted countries, the attempted is logged with the following information (be aware of data protection issues)" : "Se viene rilevato un tentativo di accesso da nazioni in lista nera o non in lista bianca, il tentativo viene registrato con le seguenti informazioni (sii consapevole dei problemi di protezione dei dati)",
    ...
    "Activate blocking of the login attempt from IPs of the specified countries." : "Attiva il blocco del tentativo di accesso dagli IP delle nazioni specificate.",
