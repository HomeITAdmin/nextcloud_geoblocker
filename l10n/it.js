OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "L'utente \"%s\" prova ad accedere con un indirizzo IP \"%s\" non valido.",
    "NOT_SHOWN_IN_LOG" : "NOT_SHOWN_IN_LOG",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "L'utente \"%s\" prova a eseguire l'accesso con indirizzo IP \"%s\" dalla nazione bloccata \"%s\".",
    "Login is delayed." : "L'accesso è ritardato.",
    "Login is blocked." : "L'accesso è bloccato.",
    "No reaction is activated." : "Nessuna reazione è attivata.",
    ...
    "The database is currently updating. Please wait until update is finished. This may take several minutes." : "Il database è in fase di aggiornamento. Attendi fino al termine dell'aggiornamento. Questo potrebbe richiedere diversi minuti.",
    ...
    "(Delaying is enforced for 30s before password check.)" : "(Il rinvio viene applicato per 30s prima del controllo della password.)",
    ...
    "(Blocking is enforced after password check!)" : "(Il blocco viene applicato dopo il controllo della password!)",
    "Test" : "Prova",
