OC.L10N.register(
    ...
    "Your attempt to login from country \"%s\" is blocked by the Nextcloud GeoBlocker App. If this is a problem for you, please contact your administrator." : "El vostre intent d'iniciar sessió des del país \"%s\" està bloquejat per l'aplicació Nextcloud GeoBlocker. Si això és un problema per a vostè, poseu-vos en contacte amb el vostre administrador.",
    ...
    "Login attempts from local network IP addresses are never blocked, delayed or logged." : "Els intents d'inici de sessió des d'adreces IP de la xarxa local mai es bloquegen, es retarden o es registren.",
    ...
    "In addition, the login attempt can also be delayed and blocked." : "A més, l'intent d'inici de sessió també pot ser esborrada i bloquejada.",
