OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "Der Benutzer \"%s\" hat versucht sich mit der ungültigen IP-Adresse \"%s\" anzumelden.",
    "NOT_SHOWN_IN_LOG" : "NOT_SHOWN_IN_LOG",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "Der Benutzer \"%s\" hat versucht sich mit der IP-Adresse \"%s\"  aus dem gesperrten Land \"%s\" anzumelden.",
    "Login is delayed." : "Anmeldung ist verzögert.",
    "Login is blocked." : "Anmeldung ist blockiert.",
    "No reaction is activated." : "Keine Reaktion ist aktiviert.",
