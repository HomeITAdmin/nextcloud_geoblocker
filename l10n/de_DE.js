OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "Falsche Konfiguration der Nextcloud (insbesondere in Containern) kann dazu führen, dass alle Zugriffe scheinbar von der IP-Adresse des lokalen Netzwerks kommen.",
    "If you are accessing from external network, this should be an external address: " : "Wenn Sie über ein externes Netzwerk zugreifen, sollte dies eine externe Adresse sein: ",
    ...
    "Whitelisting" : "Weiße Liste",
    "the following entries" : "die folgenden Einträge",
    "The following countries were chosen: " : "Die folgenden Länder wurden ausgewählt: ",
    "Reaction" : "Reaktion",
    "If a login attempt is detected from the blacklisted or not whitelisted countries, the attempted is logged with the following information (be aware of data protection issues)" : "Wenn ein Anmeldeversuch aus den auf der schwarzen oder nicht auf der weißen Liste stehenden Ländern erkannt wird, wird der Versuch mit den folgenden Informationen protokolliert (achten Sie auf Datenschutzprobleme)",
    ...
    "Activate blocking of the login attempt from IPs of the specified countries." : "Die Sperrung des Anmeldeversuchs von IPs der angegebenen Länder aktivieren.",
