OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "ERROR: \"geoip2.phar\" scheint nicht installiert zu sein oder besitzt nicht die korrekten Zugriffsrechte.",
    "No entries in the database. Please run update." : "Keine Einträge in der Datenbank. Bitte Aktualisierung starten.",
    "ERROR:" : "Fehler:",
    "OK" : "OK",
    "But IPv6 is only working on at least 64 bit systems. When upgrading the system from below 64bit remember to update the DB again." : "IPv6 funktioniert jedoch nur auf mindestens 64-Bit-Systemen. Denken Sie beim Upgrade des Systems niedriger 64bit daran, die DB erneut zu aktualisieren. ",
    ...
    "In the current implementation the login page is normally shown to everybody independend of the country. Also login attempts with a non existing user are failing as usual independend of the country." : "In der aktuellen Implementierung wird die Login-Seite normalerweise länderunabhängig jedem angezeigt. Auch Login-Versuche mit einem nicht existierenden Benutzer scheitern wie üblich länderunabhängig.",
