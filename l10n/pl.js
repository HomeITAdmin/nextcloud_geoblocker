OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be placed correctly or does not have the correct access rights." : "BŁĄD: \"geoip2.phar\" wydaje się być umieszczony niepoprawnie lub nie ma odpowiednich praw dostępu.",
    ...
    "Not the right number of entries read for IPv4 in region \"%s\". Should have been %d but was %d." : "Nieprawidłowa liczba wpisów dla IPv4 w regionie \"%s\". Powinno być %d, a było %d.",
    "Not the right number of entries read for IPv6 in region \"%s\". Should have been %d but was %d." : "Nieprawidłowa liczba wpisów dla IPv6 w regionie \"%s\". Powinno być %d, a było %d.",
    ...
    "IPv6 is not included on systems with less than 64-bit." : "IPv6 nie jest dostępny na systemach niższych niż 64-bitową wersją.",
    ...
    "Location of the database (full path including the file name):" : "Lokalizacja bazy danych (pełna ścieżka zawierająca nazwę pliku):",
