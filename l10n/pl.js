OC.L10N.register(
    ...
    "The user \"%s\" attempt to login with an invalid IP address \"%s\"." : "Użytkownik \"%s\" próbuje zalogować się przy użyciu nieprawidłowego adresu IP \"%s\".",
    "The user \"%s\" attempt to login with IP address \"%s\" from blocked country \"%s\"." : "Użytkownik \"%s\" próbuje zalogować się przy użyciu adresu IP \"%s\" z zablokowanego kraju \"%s\".",
    "Login is delayed." : "Logowanie jest opóźnione.",
    "Login is blocked." : "Logowanie jest zablokowane.",
    "No reaction is activated." : "Żadna reakcja nie jest aktywowana.",
