OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "Niewłaściwa konfiguracja Nextcloud (szczególnie w kontenerze) może prowadzić do tego, że cały dostęp może wydawać się, że pochodzi z adresu IP sieci lokalnej.",
    "If you are accessing from external network, this should be an external address: " : "Jeśli uzyskujesz dostęp z sieci zewnętrznej, powinien to być adres zewnętrzny: ",
    ...
    "Whitelisting" : "Biała lista",
    "the following entries" : "następujące wpisy",
    "The following countries were chosen: " : "Wybrano następujące kraje: ",
    "Reaction" : "Reakcja",
    "If a login attempt is detected from the blacklisted or not whitelisted countries, the attempted is logged with the following information (be aware of data protection issues)" : "Jeśli próba logowania zostanie wykryta z krajów znajdujących się na czarnej liście lub nie przypisanych na białej liście, zostanie zarejestrowana przy użyciu następujących informacji (należy pamiętać o problemach z ochroną danych)",
