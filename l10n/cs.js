OC.L10N.register(
    ...
    "Wrong Nextcloud configuration (especially in container) can lead to all access seems to come from local network IP address." : "Nesprávné nastavení Nextcloud (zejména v kontejneru) může vést k tomu, že veškerý přístup se bude jevit přicházet z IP adresy v místní síti.",
    "If you are accessing from external network, this should be an external address: " : "Pokud přistupujete z externí sítě, toto by měla být externí adresa:",
    ...
    "Blacklisting" : "Zařazování na seznam odepřených",
    "Whitelisting" : "Zařazování na seznam povolených",
    "the following entries" : "následující položky",
    "The following countries were chosen: " : "Byly zvoleny následující země:",
    "Reaction" : "Reakce",
    "If a login attempt is detected from the blacklisted or not whitelisted countries, the attempted is logged with the following information (be aware of data protection issues)" : "Pokud je zjištěn pokus o přihlášení ze zemí, ze kterých je přístup odepřen (nebo naopak takových, ze kterých není přístup výslovně povolen), pokus je zaznamenán společně s následující informací (buďte si vědomi problémů s ochranou údajů)",
    ...
    "Activate blocking of the login attempt from IPs of the specified countries." : "Aktivovat blokování pokusů o přihlášení z IP adres, pocházejících ze zadaných zemí.",
