OC.L10N.register(
    ...
    "local" : "místní",
    "default" : "výchozí",
    "ERROR: There is an unknown problem with the service." : "CHYBA: Neznámá chyba služby.",
    "ERROR: Country cannot be found." : "CHYBA: Země nenalezena.",
    "ERROR: Database is not valid, does not have the correct access rights or is not placed at %s." : "CHYBA: Problém s databází. Nemáte správné oprávnění nebo není uložena na %s.",
    "ERROR: Invalid Argument." : "CHYBA: Chybný příkaz.",
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "CHYBA: \"geoip2.phar\" není správně umístěno nebo nemáte dostatečná práva.",
    ...
    "The database is currently updating, but the service can be used during the update." : "Databáze se aktuálně aktualizuje, ale službu lze během aktualizace použít.",
    ...
    "Exception caught during Update:" : "Výjimka zachycena během aktualizace:",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "Databáze obsahuje informace o staré verzi. Resetujte databázi pomocí nástroje příkazového řádku.",
    ...
    "(Blocking is enforced before password check by throwing an \"login denied\" exception!)" : "(Blokování je vynuceno před kontrolou hesla vyvoláním výjimky „přihlášení odepřeno“!)",
    "Test" : "Vyzkoušet",
