OC.L10N.register(
    ...
    "ERROR: The database is not initialized. Please run update." : "CHYBY: Databáze není inicializována. Prosím spusťte aktualizaci.",
    "ERROR: The database is currently initializing. Please wait until update is finished. This may take several minutes." : "CHYBA: Databáze se v tuto chvíli inicializuje. Prosím vyčkejte, až bude aktualizace dokončena. To může trvat několik minut.",
    "ERROR: The database is corrupted. Please run update again." : "CHYBA: Databáze je poškozená. Prosím spusťte aktualizaci znovu.",
    "ERROR: The database is currently updating. Please wait until update is finished. This may take several minutes." : "CHYBA: Databáze se nyní aktualizuje. Prosím vyčkejte, až bude aktualizace dokončena. To může trvat několik minut.",
    "ERROR: Something is missing." : "CHYBA: Něco chybí.",
    "No database available!" : "Není k dispozici žádná databáze!",
    "Update not possible: \"allow_url_fopen\" needs to be allowed in php.ini." : "Aktualizace není možná: v php.ini je třeba povolit „allow_url_fopen“.",
    "Update not possible: PHP GMP Extension needs to be installed." : "Aktualizace není možná: je třeba, aby bylo nainstalované rozšíření PHP GMP.",
