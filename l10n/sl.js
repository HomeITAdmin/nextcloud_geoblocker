OC.L10N.register(
    ...
    "The user \"%s\" logged in with an invalid IP address \"%s\"." : "Uporabniški račun »%s« ima vzpostavljeno prijavo z neveljavnim naslovom IP »%s«.",
    "The user \"%s\" logged in with IP address \"%s\" from blocked country \"%s\"." : "Uporabniški račun »%s« ima vzpostavljeno prijavo z neveljavnim naslovom IP »%s«, ki prihaja iz države »%s«.",
    "The login of user \"%s\" with IP address \"%s\" could not be checked due to problems with location service." : "Prijave z računom »%s« prek naslova IP »%s« ni mogoče preveriti zaradi težav z storitvami določanja trenutnega mesta.",
    "OK." : "V redu",
    ...
    "local" : "krajevno",
    "default" : "privzeto",
    "ERROR: Service does not seem to be installed correctly or database is not available at %s." : "NAPAKA: Kaže, da storitev ni pravilno nameščena, ali pa ni dosegljiva podatkovna zbirka na %s.",
    "ERROR:" : "NAPAKA:",
    ...
    "The database is currently updating. Please wait until update is finished. This may take several minutes." : "Poteka posodabljanje podatkovne zbirke. Počakajte, da se postopek konča. Običajno traja nekaj minut.",
