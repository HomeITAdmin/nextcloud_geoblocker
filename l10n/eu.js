OC.L10N.register(
    ...
    "The user \"%s\" logged in with an invalid IP address \"%s\"." : "\"%s\" erabiltzaileak \"%s\" IP helbide baliogabearekin hasi du saioa.",
    "The user \"%s\" logged in with IP address \"%s\" from blocked country \"%s\"." : "\"%s\" erabiltzaileak \"%s\" IP helbidearekin hasi du saioa blokeatuta dagoen \"%s\" herrialdetik.",
    "The login of user \"%s\" with IP address \"%s\" could not be checked due to problems with location service." : "\"%s\" IP helbidea duen \"%s\" erabiltzailearen saio hastea ezin izan da egiaztatu kokaleku zerbitzuarekin dauden arazoak medio.",
    "OK." : "Ongi.",
    ...
    "The database is currently updating. Please wait until update is finished. This may take several minutes." : "Datu-basea abiarazten ari da orain. Itxaron eguneratzea amaitzen den arte. Baliteke minutu batzuk behar izatea.",
    "Something is missing." : "Zerbait falta da.",
    "No database available!" : "Ez dago datu-baserik eskuragarri!",
    "RIR seems to have changed the file format." : "Badirudi RIR-k fitxategiaren formatua aldatu duela.",
    "Exception caught during Update." : "Salbuespena topatu da eguneratzea egitean.",
    "Invalid file handle. Probably the internet connection got lost during the update." : "Fitxategi helduleku baliogabea. Seguru aski internet konexioa galdu egin da eguneratzean zehar.",
    ...
    "This is a front end to geo localization services, that allows blocking (currently only logging is possible!) of login attempts from specified countries. (Early Version)\n\nCountries can be specified using whitelisting or blacklisting.\n\nCurrently available localization services are:\n- Geoiplookup (local programm on the host)\n- MaxMind GeoLite2 (local database accessed via PHP API)\n- Data from Reginal Internet Registries (Nextcloud SQL Database build up with data downloaded from the RIRs FTP servers)\n\nFor help how to set up the localization services please have a look at the Github repository (homepage on the right side)." : "Geokokatze zerbitzuetarako front-end bat da hau, saio-haste saiakerak blokeatzeko (erregistratu bakarrik, momentuz!) aukera ematen duena zehazturiko herrialdeentzat (bertsio goiztiarra)\n\nHerrialdeak zehaztu daitezke allowlist edo blocklist bidez.\n\nUne honetan erabilgarri dauden kokatze zerbitzuak hauek dira:\n- Geoiplookup (programa lokala ostalarian)\n- MaxMind GeoLite2 (datu-base lokala, PHP API bidez atzitua)\n- Reginal Internet Registries-en datuak (RIRen FTP zerbitzarietatik deskargatutako datuekin eraikitako Nextclouden SQL Datu-basea)\n\nKokatze zerbitzuak nola konfiguratu jakiteko laguntza jasotzeko begiratu GitHub biltegian (lehen orrian, eskuin aldean).",
    "Loading" : "Kargatzen",
    "This is a front end to geo localization services, that allows blocking (currently only logging!) of login attempts from specified countries. " : "Geokokatze zerbitzuetarako front-end bat da hau, aukera ematen duena zehazturiko herrialdeetako saio-haste saiakerak blokeatzeko (erregistratu bakarrik, momentuz!).",
    "Login attempts from local network IP addresses are not blocked (or logged)." : "Sare lokaleko IP helbideen saio hasteak ez dira blokeatzen (edo erregistratzen).",
    ...
    "If you are accessing from external network, this should be an external IP address: " : "Kanpoko sare batetik atzitzen ari bazara, honek kanpoko IP helbidea izan behar luke:",
    "is local." : "lokala da.",
    ...
    "In addition, the login attempt can also be blocked" : "Gainera, saioa hasteko saiakera blokeatu egin daiteke",
    "(in a future version)" : "(etorkizuneko bertsio batean)",
    "Activate blocking of the login attempt from IP addresses of the specified countries." : "Aktibatu saio-hasiera blokeatzea zehazturiko herrialdeetako IP helbideei",
    "Test" : "Proba",
