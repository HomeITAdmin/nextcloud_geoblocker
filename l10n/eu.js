OC.L10N.register(
    ...
    "ERROR: \"geoip2.phar\" does not seem to be place correctly or do not have the correct access rights." : "ERROREA: \"geoip2.phar\" ez dago kokaleku egokian edo ez dauzka beharrezko sarbide baimenak.",
    ...
    "The database is currently updating, but the service can be used during the update." : "Datu-basea une honetan eguneratzen ari da, baina zerbitzua erabil daiteke eguneratzen den bitartean.",
    ...
    "Exception caught during Update:" : "Salbuespena topatu da eguneratzean:",
    ...
    "Database contains old version information. Reset the database using the command line tool." : "Datu-baseak bertsio zaharreko informazioa dauka. Berrezarri datu-basea komando-lerro tresna erabiliz.",
    ...
    "Login attempts from local network IP addresses are not reacted on at all." : "Bertako IP helbideen saio hasierei ez die inola ere eragiten.",
